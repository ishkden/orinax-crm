...
/**
 * POST /api/mcn/register-customer
 * Создаёт новый MCN-аккаунт для организации через MCN Partner API.
 */
export async function POST(req: NextRequest) {
  ...
  const res = await fetch(`${CRM_APP_BASE}/api/internal/mcn/register-customer`, {
    method: "POST",
    headers: {
